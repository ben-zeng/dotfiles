...
If you have already setup your dotfiles, find fresh macOS install instructions here [find instructions below](#your-own-dotfiles), or find dotfiles and preferences restore here.
...
6. Run `setup.sh` to start the installation
